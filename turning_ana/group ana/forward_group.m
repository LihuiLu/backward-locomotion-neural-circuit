...
for i = 1:length(file)
    ...
    temp2 = find(abs(data.backward_mean(:,pre_stim/bin+1:(pre_stim+xP2)/bin))-4*std(data.backward_mean(:,1:pre_stim/bin)) > 0,1,'first')
...
angular_v = 1;
speed_ylim = [0 50]; %%%angular_v   define by yourself
