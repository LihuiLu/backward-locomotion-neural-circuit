...
angle = real([group_data.angle_mean_l_quant, group_data.angle_mean_s_quant, group_data.angle_mean_r_quant]);
psth = [group_data.psth1_mean_l_quant, group_data.psth1_mean_s_quant, group_data.psth1_mean_r_quant];

groups = {'Left', 'Straight', 'Right'}; % Group labels
