function [vData] = plot_halt_gc_events_v2(vData)
...
[psth1,psth1_mean,psth1_sem] = psth_wave2(vData.fp_halt,interval,values,pre_time,post_time,control_time(1),control_time(2),current_offset,z_score);
