function [vData] = plot_turning_gc_events_v1(vData)
...
z_score= vData.z_score;
%% get psth data, left turning
assignin('base','values',values);
[psth1,psth1_mean,psth1_sem] = psth_wave2(vData.fpLeft,interval,values,pre_time,post_time,control_time(1),control_time(2),current_offset,z_score);
...
if vData.heatmap
    subplot(2,6,7:11)
    heatmapPlot(psth1,interval,pre_time,0.1,fig1,vData.clims);
    ...
    im_filename = [strrep(vData.filename,'.tdms',''),' left gcamp signal heatmap.png'];
    saveas(gcf,im_filename)
end
...
vData.times = times;
vData.psth1_l = psth1;
vData.psth1_mean_l = psth1_mean;
vData.psth1_sem_l = psth1_sem;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% get psth data for right turning%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

[psth1,psth1_mean,psth1_sem] = psth_wave2(vData.fpRight,interval,values,pre_time,post_time,control_time(1),control_time(2),current_offset,z_score);
times = -pre_time:interval:post_time;
assignin('base','a_psth1',psth1);
assignin('base','times',times);
...
[pathstr, name, ext] = fileparts(vData.filename);
title(name)
im_filename = [strrep(vData.filename,'.tdms',''),' right turning gcamp.png'];
saveas(gcf,im_filename)
...
if vData.heatmap
    ...
    c.Ticks = vData.clims;
    c.TickLabels = string(vData.clims);
    im_filename = [strrep(vData.filename,'.tdms',''),' right gcamp signal heatmap.png'];
    saveas(gcf,im_filename)
end
...
% vData.times = times;
vData.psth1_r = psth1;
vData.psth1_mean_r = psth1_mean;
vData.psth1_sem_r = psth1_sem;


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% get psth data, straight

[psth1,psth1_mean,psth1_sem] = psth_wave2(vData.fpStraight,interval,values,pre_time,post_time,control_time(1),control_time(2),current_offset,z_score);
times = -pre_time:interval:post_time;
assignin('base','a_psth1',psth1);
assignin('base','times',times);
...
% vData.times = times;
vData.psth1_s = psth1;
vData.psth1_mean_s = psth1_mean;
vData.psth1_sem_s = psth1_sem;
